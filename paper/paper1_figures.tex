% Standalone Paper 1 figures; pilot values are derived from artifacts/stage7/pilot_validation.json.
...
\newcommand{\figPaperOneCapability}{%
\begin{figure}[t]
\centering
\begin{tikzpicture}
\begin{axis}[
...
\label{fig:p1pilot}
\end{figure*}%
\input{paper1_gate_ablation_section}%
}
